...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> s = "aba"
<strong>Output:</strong> true
</pre>

<p><strong class="example">Example 2:</strong></p>

<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> s = "abca"
<strong>Output:</strong> true
...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> s = "abc"
