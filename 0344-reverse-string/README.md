...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> s = ["h","e","l","l","o"]
<strong>Output:</strong> ["o","l","l","e","h"]
</pre><p><strong class="example">Example 2:</strong></p>
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> s = ["H","a","n","n","a","h"]
